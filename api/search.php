...
if (empty($query)) {
    echo json_encode([
        "status" => "404",
        "author" => "abdiputranar",
        "message" => "Parameter 'q' wajib diisi, contoh: ?q=cinta+sabar. Dan parameter 'page' adalah opsional."
    ], JSON_PRETTY_PRINT);
    exit;
}
$formattedQuery = str_replace(" ", "_", $query);
$url = $web . "kata-bijak/kata-" . $formattedQuery . ".html";
